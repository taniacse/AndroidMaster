...
public class JavaListAdapter extends BaseAdapter {
    ...
    public static JavaListAdapter instance = null;
    public  boolean fun = true;


    public JavaListAdapter(Context context, ArrayList<String> arrayList) {
    ...
    public View getView(int i, View view, ViewGroup parent) {
        ...
        instance=this;
        arrayList.get(i);
        JavaListAdapter.ViewHolder viewHolder = null;
        View rowView = view;

        if (view == null) {

            LayoutInflater inflater = (LayoutInflater) context.getSystemService( Context.LAYOUT_INFLATER_SERVICE );
            view = inflater.inflate(R.layout.java_row_item, parent, false);

            viewHolder = new JavaListAdapter.ViewHolder();
            view.setTag(viewHolder);

        } else {

            viewHolder = (JavaListAdapter.ViewHolder) view.getTag();
