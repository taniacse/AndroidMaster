...
public class BasicListAdapter extends BaseAdapter {
    ...
    public static BasicListAdapter instance = null;

    public BasicListAdapter(Context context, ArrayList<String> arrayList) {
    ...
    public View getView(int i, View view, ViewGroup parent) {
        ...
        if (view == null) {
            ...
            view = inflater.inflate(R.layout.basic_row_item, parent, false);

            viewHolder = new BasicListAdapter.ViewHolder();
            view.setTag(viewHolder);

        } else {

            viewHolder = (BasicListAdapter.ViewHolder) view.getTag();
