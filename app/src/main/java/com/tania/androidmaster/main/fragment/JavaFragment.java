...
import com.tania.androidmaster.main.adapter.JavaListAdapter;
...
public class JavaFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View inflaterView = inflater.inflate(R.layout.fragment_java, container, false);

        javaTopicsListView = (ListView) inflaterView.findViewById(R.id.javaList);

        arrayList.add("What is OOP ?");
        arrayList.add("What is JAVA and Why JAVA ?");
        arrayList.add("Basic Level");
        arrayList.add("Mid Level");
        arrayList.add("Advance Level");
        arrayList.add("Some useful video tutorial");
        arrayList.add("Some useful Reference Link");

        Log.d("ArrayList ", " ArrayList" + arrayList);

        JavaListAdapter javaListAdapter = new JavaListAdapter(getActivity(),arrayList);

        javaTopicsListView.setAdapter(javaListAdapter);
